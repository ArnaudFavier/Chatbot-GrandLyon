...
// Services.nearestPointCulturel({lat: 45.756715, long: 4.831561}, 50, callback);

// Appel de test pour obtenir les 5 stations velov les plus proches d'une position,
// en passant les coordonnées de Place Bellecour (à décommenter pour tester)
// Services.nearestVelov({lat: 45.756715, long: 4.831561}, 5, callback);

// Appel de test pour obtenir les restaurants les plus proches d'une position,
// en passant les coordonnées de Place Bellecour (à décommenter pour tester)
Services.nearestRestaurantsWithKeywords({lat: 45.756715, long: 4.831561}, ['sushi','asiatique'], callback);

// Appel de test pour obtenir les 3 fontaines les plus proches d'une position,
// en passant les coordonnées de Place Bellecour (à décommenter pour tester)
// Services.nearestFontaines({lat: 45.756715, long: 4.831561}, 3, callback);
...
// en passant les coordonnées de Place Bellecour (à décommenter pour tester)
// Services.nearestLieuCulte({lat: 45.756715, long: 4.831561}, 100, callback);

// Appel de test pour obtenir les 5 lieux de culte d'un type donné, les plus proches d'une position,
// en passant les coordonnées de Place Bellecour (à décommenter pour tester)
// Services.nearestLieuCulteType({lat: 45.756715, long: 4.831561}, 5, callback, 'Synagogue');
...
// en passant les coordonnées de Place Bellecour (à décommenter pour tester)
// Services.nomVillePourCoordonnees({lat:  40.730610, long: -73.935242}, callback); // New York
// Services.nomVillePourCoordonnees({lat: 45.756715, long: 4.831561}, callback); // Place Bellecour
// Services.nomVillePourCoordonnees({lat:  55.7522200, long: 37.6155600}, callback); // Saint-Marcel